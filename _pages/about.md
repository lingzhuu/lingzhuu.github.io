...
# 🎨 Projects
- *2022.05*, Establish a prediction model which allow Hepatitis prediction for new variants of a patient. Used machine learning algorithms such as logistic regression, random forests, support vector machine to build the model and conducteded prediction web app. \| [\[video\]](https://drive.google.com/file/d/1GxdAijcPeJvuHQzMjPOBG1wMG3GcMPDg/view?usp=sharing)
